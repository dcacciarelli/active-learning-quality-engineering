...
This repo contains:
1. `requirements`: file that contains a list of all the packages installed in the environment used, along with their version numbers.
2. `image_preprocessing`: torch implementation of a ResNet-18 feature extractor.
3. `feature_extraction`: notebook showing how to obtain preprocessed features from the images.
4. `sampling_strategies`: functions for performing random sampling and margin sampling.
